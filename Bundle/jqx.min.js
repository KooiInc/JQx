...
`,n)})}function ft(r,e,...t){let n=dt(e,r);return t?.forEach(o=>ut(n,o,r)),n}function dt(r,e){switch(r=de(e)?pt(r):r?.isJQx?r.first():r,!0){case u(r,String):return q(e,Ae(r,e)?{html:r}:{text:r});case u(r,Node):return gt(e,r);default:return q(e,r)}}function mt(r){return delete r.data,Object.keys(r).length<1||Object.keys(r).forEach(e=>{let t=e.toLowerCase();t in $e&&(r[$e[t]]=r[e],delete r[e])}),r}function gt(r,e){let t=q(r);return t.append(e),t}function q(r,e={}){e=Fe(e,{});let t=Object.entries(e.data??{}),n=Object.assign(de(r)?new Comment(e?.text):document.createElement(r),mt(e));return t.length&&t.forEach(([o,l])=>n.dataset[o]=String(l)),n}function Fe(r,e){return e?u(r,{isTypes:Object,notTypes:[Array,null,NaN,Proxy],defaultValue:e}):u(r,{isTypes:Object,notTypes:[Array,null,NaN,Proxy]})}function pt(r){return Fe(r)?r?.text??r?.textContent??"":String(r)}function yt(r){return q("b",{style:"color:red",text:`'${r}' is not a valid HTML-tag`})}function Ae(r,e){return!de(e)&&u(r,String)&&/<.*>|&[#|0-9a-z]+[^;];/i.test(r)}function bt(r){return r?.constructor===Comment||r?.constructor===CharacterData}function de(r){return r?.constructor===Comment||/comment/i.test(r)}function ht(r){return!u(q(r),HTMLUnknownElement)}function St(r){return(e,...t)=>ft(r,e,...t)}var{IS:u,maybe:me,$Wrap:Sr,xProxy:xr,isNothing:vr}=xt();function xt(){Symbol.proxy=Symbol.for("toa.proxy"),Symbol.is=Symbol.for("toa.is"),Symbol.type=Symbol.for("toa.type"),Symbol.isSymbol=Symbol.for("toa.isASymbol"),y();let r=x(),[e,t]=[g(),H()];return t.custom(),{IS:n,maybe:r,$Wrap:e,isNothing:S,xProxy:t};function n(i,...s){if(r({trial:d=>"isTypes"in(s?.[0]??{})})){let d=s[0];return"defaultValue"in d?m(i,d):"notTypes"in d?a(i,d):n(i,...[d.isTypes].flat())}let f=typeof i=="symbol"?Symbol.isSymbol:i;return s.length>1?h(f,...s):l(i,...s)}function o(i){return i?.[Symbol.proxy]??n(i)}function l(i,...s){let{noInput:f,noShouldbe:d,compareTo:w,inputCTOR:F,isNaN:j,isInfinity:k,shouldBeFirstElementIsNothing:B}=p(i,...s);switch(s=s.length&&s[0],!0){case B:return String(i)===String(w);case(i?.[Symbol.proxy]&&d):return i[Symbol.proxy];case j:return d?"NaN":r({trial:J=>String(w)})===String(i);case k:return d?"Infinity":r({trial:J=>String(w)})===String(i);case f:return d?String(i):String(w)===String(i);case F===Boolean:return s?F===s:"Boolean";default:return b(i,s,d,c(i,F))}}function c(i,s){return i===0?Number:i===""?String:i?s:{name:String(i)}}function p(i,...s){let f=s.length<1,d=!f&&s[0],w=!f&&S(s[0]),F=i==null,j=!F&&Object.getPrototypeOf(i)?.constructor,k=r({trial:J=>String(i)})==="NaN",B=r({trial:J=>String(i)})==="Infinity";return{noInput:F,noShouldbe:f,compareTo:d,inputCTOR:j,isNaN:k,isInfinity:B,shouldBeFirstElementIsNothing:w}}function b(i,s,f,d){switch(!0){case(!f&&s===i||i?.[Symbol.proxy]&&s===Proxy):return!0;case r({trial:w=>String(s)})==="NaN":return String(i)==="NaN";case(i?.[Symbol.toStringTag]&&n(s,String)):return String(s)===i[Symbol.toStringTag];default:return s?r({trial:w=>i instanceof s})||s===d||s===Object.getPrototypeOf(d)||`${s?.name}`===d?.name:i?.[Symbol.toStringTag]&&`[object ${i?.[Symbol.toStringTag]}]`||d?.name||String(d)}}function h(i,...s){return s.some(f=>n(i,f))}function S(i,s=!1){let f=i==null;return f=s?f||n(i,1/0)||n(i,NaN):f,f}function x(){let i=(s,f)=>s?.constructor===Function?s(f):void 0;return function({trial:s,whenError:f=()=>{}}={}){try{return i(s)}catch(d){return i(f,d)}}}function g(){return function(i){return Object.freeze({get value(){return i},get[Symbol.type](){return o(i)},get type(){return o(i)},[Symbol.is](...s){return n(i,...s)},is(...s){return n(i,...s)}})}}function m(i,{defaultValue:s,isTypes:f=[void 0],notTypes:d}={}){return f=f?.constructor!==Array?[f]:f,d=d&&d?.constructor!==Array?[d]:[],d.length<1?n(i,...f)?i:s:a(i,{isTypes:f,notTypes:d})?i:s}function a(i,{isTypes:s=[void 0],notTypes:f=[void 0]}={}){return s=s?.constructor!==Array?[s]:s,f=f?.constructor!==Array?[f]:f,n(i,...s)&&!n(i,...f)}function y(){Object.getOwnPropertyDescriptors(Object.prototype)[Symbol.is]||(Object.defineProperties(Object.prototype,{[Symbol.type]:{get(){return o(this)},enumerable:!1,configurable:!1},[Symbol.is]:{value:function(...i){return n(this,...i)},enumerable:!1,configurable:!1}}),Object.defineProperties(Object,{[Symbol.type]:{value(i){return o(i)},enumerable:!1,configurable:!1},[Symbol.is]:{value:function(i,...s){return n(i,...s)},enumerable:!1,configurable:!1}}))}function v(i){let s=String(Object.getPrototypeOf(i)?.constructor);return s.slice(s.indexOf("ion")+3,s.indexOf("(")).trim()}function E(i){let s=i.set;return i.set=(f,d,w)=>d===Symbol.proxy?f[d]=w:s(f,d,w),i}function H(){let i=Proxy;return{native(){Proxy=i},custom(){Proxy=new i(i,{construct(s,f){for(let w of f)w.set&&(w=E(w));let d=new s(...f);return d[Symbol.proxy]=`Proxy (${v(f[0])})`,d}})}}}}var{IS:oe,maybe:Er,$Wrap:Lr,xProxy:Cr,isNothing:$r}=vt();function vt(){Symbol.proxy=Symbol.for("toa.proxy"),Symbol.is=Symbol.for("toa.is"),Symbol.type=Symbol.for("toa.type"),Symbol.isSymbol=Symbol.for("toa.isASymbol"),y();let r=x(),[e,t]=[g(),H()];return t.custom(),{IS:n,maybe:r,$Wrap:e,isNothing:S,xProxy:t};function n(i,...s){if(r({trial:d=>"isTypes"in(s?.[0]??{})})){let d=s[0];return"defaultValue"in d?m(i,d):"notTypes"in d?a(i,d):n(i,...[d.isTypes].flat())}let f=typeof i=="symbol"?Symbol.isSymbol:i;return s.length>1?h(f,...s):l(i,...s)}function o(i){return i?.[Symbol.proxy]??n(i)}function l(i,...s){let{noInput:f,noShouldbe:d,compareTo:w,inputCTOR:F,isNaN:j,isInfinity:k,shouldBeFirstElementIsNothing:B}=p(i,...s);switch(s=s.length&&s[0],!0){case B:return String(i)===String(w);case(i?.[Symbol.proxy]&&d):return i[Symbol.proxy];case j:return d?"NaN":r({trial:J=>String(w)})===String(i);case k:return d?"Infinity":r({trial:J=>String(w)})===String(i);case f:return d?String(i):String(w)===String(i);case F===Boolean:return s?F===s:"Boolean";default:return b(i,s,d,c(i,F))}}function c(i,s){return i===0?Number:i===""?String:i?s:{name:String(i)}}function p(i,...s){let f=s.length<1,d=!f&&s[0],w=!f&&S(s[0]),F=i==null,j=!F&&Object.getPrototypeOf(i)?.constructor,k=r({trial:J=>String(i)})==="NaN",B=r({trial:J=>String(i)})==="Infinity";return{noInput:F,noShouldbe:f,compareTo:d,inputCTOR:j,isNaN:k,isInfinity:B,shouldBeFirstElementIsNothing:w}}function b(i,s,f,d){switch(!0){case(!f&&s===i||i?.[Symbol.proxy]&&s===Proxy):return!0;case r({trial:w=>String(s)})==="NaN":return String(i)==="NaN";case(i?.[Symbol.toStringTag]&&n(s,String)):return String(s)===i[Symbol.toStringTag];default:return s?r({trial:w=>i instanceof s})||s===d||s===Object.getPrototypeOf(d)||`${s?.name}`===d?.name:i?.[Symbol.toStringTag]&&`[object ${i?.[Symbol.toStringTag]}]`||d?.name||String(d)}}function h(i,...s){return s.some(f=>n(i,f))}function S(i,s=!1){let f=i==null;return f=s?f||n(i,1/0)||n(i,NaN):f,f}function x(){let i=(s,f)=>s?.constructor===Function?s(f):void 0;return function({trial:s,whenError:f=()=>{}}={}){try{return i(s)}catch(d){return i(f,d)}}}function g(){return function(i){return Object.freeze({get value(){return i},get[Symbol.type](){return o(i)},get type(){return o(i)},[Symbol.is](...s){return n(i,...s)},is(...s){return n(i,...s)}})}}function m(i,{defaultValue:s,isTypes:f=[void 0],notTypes:d}={}){return f=f?.constructor!==Array?[f]:f,d=d&&d?.constructor!==Array?[d]:[],d.length<1?n(i,...f)?i:s:a(i,{isTypes:f,notTypes:d})?i:s}function a(i,{isTypes:s=[void 0],notTypes:f=[void 0]}={}){return s=s?.constructor!==Array?[s]:s,f=f?.constructor!==Array?[f]:f,n(i,...s)&&!n(i,...f)}function y(){Object.getOwnPropertyDescriptors(Object.prototype)[Symbol.is]||(Object.defineProperties(Object.prototype,{[Symbol.type]:{get(){return o(this)},enumerable:!1,configurable:!1},[Symbol.is]:{value:function(...i){return n(this,...i)},enumerable:!1,configurable:!1}}),Object.defineProperties(Object,{[Symbol.type]:{value(i){return o(i)},enumerable:!1,configurable:!1},[Symbol.is]:{value:function(i,...s){return n(i,...s)},enumerable:!1,configurable:!1}}))}function v(i){let s=String(Object.getPrototypeOf(i)?.constructor);return s.slice(s.indexOf("ion")+3,s.indexOf("(")).trim()}function E(i){let s=i.set;return i.set=(f,d,w)=>d===Symbol.proxy?f[d]=w:s(f,d,w),i}function H(){let i=Proxy;return{native(){Proxy=i},custom(){Proxy=new i(i,{construct(s,f){for(let w of f)w.set&&(w=E(w));let d=new s(...f);return d[Symbol.proxy]=`Proxy (${v(f[0])})`,d}})}}}}var K=wt;function wt({styleSheet:r,createWithId:e}={}){let{tryParseAtOrNestedRules:t,ruleExists:n,checkParams:o,sheet:l,removeRules:c,consider:p,currentSheetID:b}=Et({styleSheet:r,createWithId:e});function h(a,y){if(a&&y.removeProperties){Object.keys(y.removeProperties).forEach(v=>a.style.removeProperty(De(v)));return}Object.entries(y).forEach(([v,E])=>{v=De(v.trim()),E=E.trim();let H;if(/!important/.test(E)&&(E=E.slice(0,E.indexOf("!important")).trim(),H="important"),!CSS.supports(v,E))return console.error(`StylingFactory ${b} error: '${v}' with value '${E}' not supported (yet)`);He(()=>a.style.setProperty(v,E,H),`StylingFactory ${b} (setRule4Selector) failed`)})}function S(a,y,v=l){if(a=a?.trim?.(),!oe(a,String)||!a.length||/[;,]$/g.test(a))return console.error(`StylingFactory ${b} (setRules): [${a||"[no selector given]"}] is not a valid selector`);if(y.removeRule)return c(a);let E=n(a,!0),H=E||v.cssRules[v.insertRule(`${a} {}`,v.cssRules.length||0)];return p(()=>h(H,y),a,E)}function x(a){let y=a.trim().split(/{/,2),v=y.shift().trim();if(!oe(v,String)||!v?.trim()?.length)return console.error(`StylingFactory ${b} (doParse): no (valid) selector could be extracted from rule ${ge(a)}`);let E=Dt(y.shift());return He(()=>S(v,E),`StylingFactory ${b} (setRules) failed`)}function g(a){let y=t(a);return y.done?y.existing:x(a)}function m(a,y){return a.trim().startsWith("@media")?g(Lt(a,y)):S(a,y)}return function(a,y={}){return o(a,y)&&(Object.keys(y).length?m(a,y):g(a))}}function Et({styleSheet:r,createWithId:e}){let t="Note: The rule or some of its properties may not be supported by your browser (yet)",n=`for style#${e}`;r=e?o(e):r;function o(g){let m=document.querySelector(`#${g}`)?.sheet;if(m)return m;let a=Object.assign(document.createElement("style"),{id:g});return document.head.insertAdjacentElement("beforeend",a),a.sheet}function l(g){return console.error(`StylingFactory ${n} [rule: ${g}]
    => @charset, @namespace and @import are not supported here`),{done:!0}}function c(g,m){return[...r.rules].find(a=>m?Ne(a.selectorText||"",g):Tt`${$t(g)}${[..."gim"]}`.test(a.cssText))}function p(g){return/^@charset|@import|namespace/i.test(g.trim())?l(g):g.match(/}/g)?.length>1?{existing:S(g,1),done:!0}:{done:!1}}function b(g){let m=[...r.cssRules].reduce((y,v,E)=>Ne(v.selectorText||"",g)&&y.concat(E)||y,[]),a=m.length;return m.forEach(y=>r.deleteRule(y)),a>0?console.info(`\u2714 Removed ${a} instance${a>1?"s":""} of selector ${g} from ${n.slice(4)}`):console.info(`\u2714 Remove rule: selector ${g} does not exist in ${n.slice(4)}`)}function h(g,m){return g&&oe(g,String)&&g.trim().length>0&&oe(m,Object)||(console.error(`StylingFactory ${n} called with invalid parameters`),!1)}function S(g){g=g.trim();let m=g.slice(0,g.indexOf("{")).trim(),a=!!c(m);try{return r.insertRule(`${g}`,r.cssRules.length),a}catch(y){return console.error(`StylingFactory ${n} (tryParse) ${y.name} Error:
${y.message}
Rule: ${ge(g)}
${t}`),a}}function x(g,m,a){try{return g(),a}catch(y){return console.error(`StylingFactory ${n} (tryAddOrModify) ${y.name} Error:
${y.message}
Rule: ${ge(m)}
