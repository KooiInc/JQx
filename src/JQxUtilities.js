import {
  ...
  PopupFactory, tagLib, HandlerFactory, getHandlerName, clearAllTimers, convert2Bool
...
export {
  ...
  cleanupHtml, PopupFactory, tagLib, HandlerFactory, getHandlerName, clearAllTimers, convert2Bool
};
